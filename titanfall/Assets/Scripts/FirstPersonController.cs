...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if(Input.GetKeyDown(KeyCode.C) && !m_Jumping && (PlayerScript.Instance.currentPlayerType == PlayerType.pilot)){
                crouch();
            }
        ...
        private void OnCollisionEnter(Collision other) {
            if(m_Jumping && sprintPressed && !other.gameObject.tag.Equals("Border") && (PlayerScript.Instance.currentPlayerType == PlayerType.pilot)){
                wallrun = true;
                // wallrunSemaphore++;
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded)
            {
                ...
                if (m_Jump && (PlayerScript.Instance.currentPlayerType == PlayerType.pilot))
                {
                    m_MoveDir.y = m_JumpSpeed;
                    PlayJumpSound();
                    m_Jump = false;
